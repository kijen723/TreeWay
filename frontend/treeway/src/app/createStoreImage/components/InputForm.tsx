...
export default function InputForm({
  ...
  const [region, setRegion] = useState(''); // 지역 상태
  const [subRegion, setSubRegion] = useState(''); // 시/군/구 상태
  const [business, setBusiness] = useState(''); // 업종 상태
  const [subBusiness, setSubBusiness] = useState(''); // 세부 업종 상태
  const [budget, setBudget] = useState(''); // 예산 상태
...
>>>>>>> 44c262d (fix:프롬프트 임의설정, 스피너추가, 분석이력페이지 개발 완료)
...
=======
    const parsedRegion: string = region;
>>>>>>> 44c262d (fix:프롬프트 임의설정, 스피너추가, 분석이력페이지 개발 완료)
...
=======
    ...
    if (budgetInt < averageCost * 0.5) {
      prompt = `
            I want to run a small ${business} business with a budget of ${budget} won in ${region} ${subRegion}.
>>>>>>> 44c262d (fix:프롬프트 임의설정, 스피너추가, 분석이력페이지 개발 완료)
        ...
        <div className={styles.column}>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              setSubRegion(''); // 지역 변경 시 시/군/구 초기화
            }}
          >
...
>>>>>>> 44c262d (fix:프롬프트 임의설정, 스피너추가, 분석이력페이지 개발 완료)
        ...
        <div className={styles.column}>
          <label htmlFor='subRegion' className={styles.formLabel}>
            시/군/구
          </label>
          <select
            id='subRegion'
          ...
          >
            ...
            {region &&
              regions[region].map((subRegionName) => (
      ...
      <div className={styles.row}>
        <div className={styles.column}>
          <label htmlFor='business' className={styles.formLabel}>
            업종
          </label>
          <select
            id='business'
            ...
            onChange={(e) => {
              ...
              setSubBusiness(''); // 업종 변경 시 세부 업종 초기화
            }}
          >
            <option value=''>업종을 선택하세요</option>
            {Object.keys(businesses).map((businessName) => (
        ...
        <div className={styles.column}>
          <label htmlFor='subBusiness' className={styles.formLabel}>
            세부 업종
          </label>
          <select
            id='subBusiness'
          ...
          >
            ...
            {business &&
              businesses[business].map((subBusinessName) => (
                <option key={subBusinessName} value={subBusinessName}>
                  {subBusinessName}
                </option>
              ))}
          </select>
      ...
      <div className={styles.row}>
        ...
        <div className={styles.column}>
          <button className={styles.analyzeButton} onClick={handleSubmitBtn}>
            분석하기
          </button>
        </div>
      </div>
